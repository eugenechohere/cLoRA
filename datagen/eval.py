...
async def run_evaluation():
    ...
    async with OpenAIClient() as client:
        ...
        for i in range(0, len(image_paths), chunk_size):
            ...
            text = "Provided is a sequence of frames of a screen. Describe all the actions that are taken throughout the frames, without mentioning frames specifically. Please be as descriptive as possible about all the actions taken and changes that are made so that all the necessary context can be included in the description without sounding overbearing. Please be descriptive and explicit about the specific nuances in the context including any relevant text present and UI elements that are present and deemed relevant to jot down, including actions and elements that don't explicitly impact the webpage, e.g. side UI elements,scrolling, text text being highlighted by the user, tool tips, button presses/button state changes, etc.. Please be as explicit and descriptive and verbose as possible about the current context. Just give the description without any other chatty text."
            if i != 0:
                text = "Here is a continuation of the previous sequence of actions, provided as a sequence of frames of a screen. Describe all the actions that are taken throughout the frames, without mentioning frames specifically. Please be as descriptive as possible about all the actions taken and changes that are made so that all the necessary context can be included in the description without sounding overbearing. Please be descriptive and explicit about the specific nuances in the context, including any relevant text present UI elements that are present and deemed relevant to jot down, including actions and elements that don't explicitly impact the webpage, e.g. side UI elements, scrolling, text being highlighted by the user, tool tips, button presses/button state changes, etc... Please be as explicit and descriptive and verbose as possible about the current context. In your description, do not repeat information or nuances that have already been mentioned in previous turns. Only describe new actions or changes that have been taken since."
